...
def calculate_price(contract):
    ...
    price_8_14_days = tariff.price_8_14_days if hasattr(tariff, 'price_8_14_days') else 0
    price_15_30_days = tariff.price_15_30_days if hasattr(tariff, 'price_15_30_days') else 0
