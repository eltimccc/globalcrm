...
from .views import ContractDeleteView, ContractDetailView, ContractEditView, ContractListView, ContractCreateView, calculate_price_ajax, get_car_tariff, get_end_date
